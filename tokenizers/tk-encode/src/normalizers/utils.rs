...
// There is no `Sequence` normalizer type any more: the reader flattens a config `Sequence` into a
// `Vec<pipeline::PipelineNormalizer>`, and `pipeline::NormalizerChain` applies it.
