...
///
/// Re-exported from `utils::cache`, which is `pub(crate)`: both numbers have been public API under
/// these names since before the split, and a second copy of them anywhere else would be a second
/// answer to "how big is a BPE cache".
