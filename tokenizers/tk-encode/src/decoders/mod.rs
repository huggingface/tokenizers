...
// two wrappers, and a variant in two wrappers cannot be given a serde mirror for one without also
// doing the other. A decoder is now a decoder and nothing else.
//
