...
#[derive(AutoDebug, Clone, Copy, PartialEq, Serialize, Deserialize, Eq, Default, AutoDisplay)]
...
#[derive(AutoDebug, Clone, Copy, PartialEq, Serialize, Deserialize, Eq, AutoDisplay)]
