...
//! never drift apart. `bitcanon` never *runs* these at runtime — it works off the tag stream; the
...
/// the pattern as a converted tokenizer would spell it. Reproduced by [`crate::bitcanon_kimi`].
