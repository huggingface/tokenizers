...
class Encoding:
    ...
    @staticmethod
    def merge(encodings: typing.Any, growing_offsets: bool = True) -> tokenizers.Encoding: ...
    @property
    ...
    def pad(self, /, length: int, **kwargs) -> typing.Any: ...
    @property
    ...
    def truncate(self, /, max_length: int, stride: int = 0, direction: str = "right") -> typing.Any: ...
    @property
...
class PreTokenizedString:
    ...
    def to_encoding(self, /, type_id: int = 0, word_idx: int | None = None) -> tokenizers.Encoding: ...
...
class Tokenizer:
    ...
    def async_encode(self, /, sequence: typing.Any, pair: typing.Any | None = None, is_pretokenized: bool = False, add_special_tokens: bool = True) -> typing.Any: ...
    def async_encode_batch(self, /, input: typing.Any, is_pretokenized: bool = False, add_special_tokens: bool = True) -> typing.Any: ...
    def async_encode_batch_fast(self, /, input: typing.Any, is_pretokenized: bool = False, add_special_tokens: bool = True) -> typing.Any: ...
    def decode(self, /, ids: typing.Any, skip_special_tokens: bool = True) -> str: ...
    def decode_batch(self, /, sequences: typing.Any, skip_special_tokens: bool = True) -> typing.Any: ...
    @property
    def decoder(self, /) -> typing.Any: ...
    @decoder.setter
    def decoder(self, /, decoder: tokenizers.decoders.Decoder | None) -> None: ...
    def enable_padding(self, /, **kwargs) -> typing.Any: ...
    def enable_truncation(self, /, max_length: int, **kwargs) -> typing.Any: ...
    def encode(self, /, sequence: typing.Any, pair: typing.Any | None = None, is_pretokenized: bool = False, add_special_tokens: bool = True) -> tokenizers.Encoding: ...
    def encode_batch(self, /, input: typing.Any, is_pretokenized: bool = False, add_special_tokens: bool = True) -> typing.Any: ...
    def encode_batch_fast(self, /, input: typing.Any, is_pretokenized: bool = False, add_special_tokens: bool = True) -> typing.Any: ...
    @property
    def encode_special_tokens(self, /) -> bool: ...
    @encode_special_tokens.setter
    def encode_special_tokens(self, /, value: bool) -> None: ...
    @staticmethod
    def from_buffer(buffer: typing.Any) -> tokenizers.Tokenizer: ...
    @staticmethod
    def from_file(path: str) -> tokenizers.Tokenizer: ...
    @staticmethod
    def from_pretrained(identifier: str, revision: str = ..., token: str | None = None) -> tokenizers.Tokenizer: ...
    @staticmethod
    def from_str(json: str) -> tokenizers.Tokenizer: ...
    def get_added_tokens_decoder(self, /) -> typing.Any: ...
    def get_vocab(self, /, with_added_tokens: bool = True) -> typing.Any: ...
    ...
    def post_process(self, /, encoding: tokenizers.Encoding, pair: tokenizers.Encoding | None = None, add_special_tokens: bool = True) -> tokenizers.Encoding: ...
    @property
    ...
    def save(self, /, path: str, pretty: bool = True) -> typing.Any: ...
    ...
    def train_from_iterator(self, /, iterator: typing.Any, trainer: tokenizers.trainers.Trainer | None = None, length: int | None = None) -> typing.Any: ...
    @property
