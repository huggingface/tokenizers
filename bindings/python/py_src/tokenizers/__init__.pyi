...
class Tokenizer:
    ...
    def decode(self, /, ids: typing.Any, skip_special_tokens: bool | None = None) -> str: ...
    def decode_batch(self, /, sequences: typing.Any, skip_special_tokens: bool | None = None) -> list[str]: ...
    @property
    ...
    def encode(self, /, sequence: typing.Any, pair: typing.Any | None = None, is_pretokenized: bool = False, add_special_tokens: bool = True) -> Encoding: ...
    def encode_batch(self, /, input: typing.Any, is_pretokenized: bool = False, add_special_tokens: bool = True) -> list[Encoding]: ...
    def encode_batch_fast(self, /, input: typing.Any, is_pretokenized: bool = False, add_special_tokens: bool = True) -> list[Encoding]: ...
    @property
